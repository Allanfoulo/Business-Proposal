...
def analyze_business_sub_sector(data):
    prompt = f"""
    Analyze the business sub-sector in Lesotho for {data['company_name']}. The company operates in the {data['industry']} industry. Provide insights into the sub-sector's growth, opportunities, and challenges.
    """
    return prompt
